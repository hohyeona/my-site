    ...
    <>
      <header className="fixed top-0 left-0 w-full z-50 bg-zinc-800 text-white flex items-center justify-between px-6 py-4">
        ...
        <nav className="gap-4 hidden md:flex">
          <a href="#" className="hover:text-gray-300">메뉴1</a>
          <a href="#" className="hover:text-gray-300">메뉴2</a>
          <a href="#" className="hover:text-gray-300">메뉴3</a>
          <a href="#" className="hover:text-gray-300">메뉴4</a>
          <a href="#" className="hover:text-gray-300">메뉴5</a>
        </nav>
        <div
