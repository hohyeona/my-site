...
export default function InsightSection() {
  return (
    <section className="relative bg-no-repeat bg-cover bg-center h-[412px]" style={{ backgroundImage: "url('/img/insight.png')" }}>
      ...
      <div className="relative z-10 max-w-[1300px] mx-auto px-4 h-full flex justify-center items-center">
        <div className="text-white text-center">
          ...
          <p className="text-base text-gray-200">생각과 경험을 공유합니다.</p>
        </div>
      </div>
    </section>
  );
